 ...
 */
final class Version20240901203611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cargo (id INT NOT NULL, funcao VARCHAR(255) NOT NULL, carga_horaria INTERVAL NOT NULL, PRIMARY KEY(id))');
